...
class BommelerwaardSearchModule {
	
	// Class information
	public $classname 		= "BommelerwaardSearchModule";	// Name of the class
	public $display_name 	= "Streekarchief Bommelerwaard";// Name to display on the dropdown menu
	...
	public $link			= "http://www.streekarchiefbommelerwaard.nl/index.php?option=com_genealogie_zoeken&Itemid=187&sub=resultaat";
