...
class TilburgSearchModule {
	
	// Class information
	public $classname 		= "TilburgSearchModule";		// Name of the class
	public $display_name 	= "Regionaal Archief Tilburg";	// Name to display on the dropdown menu
	...
	public $link			= "http://www.regionaalarchieftilburg.nl/index.php?option=com_genealogie_zoeken&Itemid=47&sub=resultaat";
