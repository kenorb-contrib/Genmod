...
===================================================*/
# $Id: facts.tr.php,v 1.1 2005/10/23 21:54:42 roland-d Exp $
...
$factarray["_GMU"]	= "Son değişikliği yapan";
...
if (file_exists($GM_BASE_DIRECTORY . "languages/facts.tr.extra.php")) require $GM_BASE_DIRECTORY . "languages/facts.tr.extra.php";
