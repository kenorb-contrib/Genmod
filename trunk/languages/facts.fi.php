...
# $Id: facts.fi.php,v 1.1 2005/10/23 21:54:42 roland-d Exp $
...
$factarray["_GMU"]	= "Viimeiseksi muuttanut";
...
if (file_exists($GM_BASE_DIRECTORY . "languages/facts.fi.extra.php")) require $GM_BASE_DIRECTORY . "languages/facts.fi.extra.php";
