 ...
 * @package Genmod
 * @subpackage Admin
 * @version $Id: editlang_edit_settings.php,v 1.6 2006/02/12 19:12:04 sjouke Exp $
 */
...
if ($action == "new_lang") {
  ...
  $gm_language[$ln]    = "languages/lang.".$new_shortcut.".php";
...
if ($action != "save" and $action != "toggleActive") {
  ...
  print "<tr>";
  if ($action == "new_lang") {
    print "<td class=\"facts_label\">" . $gm_lang["add_new_language"] . "</td>";
  }
  else {
    print "<td class=\"facts_label\">" . $gm_lang["config_lang_utility"] . "</td>";
  }
  print "</tr>";
  print "<tr>";
  print "<td class=\"facts_value\" style=\"text-align:center; \"><b>" . $gm_lang[$d_LangName];
  print "</b></td></tr>";
  print "</table>\n";
  ...
  print "<br /><center>";
  print "<input type=\"submit\" value=\"" . $gm_lang["lang_save"] . "\" />";
  print "&nbsp;&nbsp;";
  print "<input type=\"submit\" value=\"" . $gm_lang["cancel"] . "\" onclick=\"document.Form1.action.value='cancel'\" />";
  print "</center><br />";
  ...
  print "<tr>";
  if (!isset($v_original_lang_name)) $v_original_lang_name = $gm_lang[$ln];    
  print "<td class=\"facts_label\" >";
  print str_replace("#D_LANGNAME#", $gm_lang[$d_LangName], $gm_lang["original_lang_name"]);
  ...
  if ($action != "new_lang"){
    print "<tr>";
    print "<td class=\"facts_label\" >";
    print $gm_lang["lang_filenames"]; 
    print " <a href=\"#\" onclick=\"return helpPopup('lang_filenames_help'); \"><b style=\"color: red; cursor: help; \">?</b></a>";
    print "</td>";
    write_td_with_textdir_check();

    print $v_config_filename;
    if (!file_exists($v_config_filename)) print "&nbsp;&nbsp;<b class=\"error\">" . $gm_lang["file_does_not_exist"] . "</b>";
    print "<br />";

    print $v_factsfile;
    if (!file_exists($v_factsfile)) print "&nbsp;&nbsp;<b class=\"error\">" . $gm_lang["file_does_not_exist"] . "</b>";
    print "<br />";

    print $v_helpfile;
    if (!file_exists($v_helpfile)) print "&nbsp;&nbsp;<b class=\"error\">" . $gm_lang["file_does_not_exist"] . "</b>";
    print "<br />";

    print $v_lang_filename;
    if (!file_exists($v_lang_filename)) print "&nbsp;&nbsp;<b class=\"error\">" . $gm_lang["file_does_not_exist"] . "</b>";
...
if ($action == "save") {
  ...
  if ($_POST["new_old"] == "new") {
    ...
    $gm_lang[$ln]    = $ln;
    $gm_language[$ln]    = "languages/lang.".$v_lang_shortcut.".php";
