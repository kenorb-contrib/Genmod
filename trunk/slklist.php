...
{
global $gm_lang, $DATE_FORMAT, $LANGUAGE, $USE_HEBREW_DATES;
...
//--		$datestr = preg_replace("/$value(\W)/i", $gm_lang[$value]."\$1", $datestr);
//--	}
}
	return $datestr;
}
...
//--	go in the loop
	...
	{	$i++;
		...
		if ($oldtabblad !== $mytabblad)
		{
			...
			$first= 0;
 			print ($gm_lang["excel_tab"] . $mytabblad . $gm_lang["excel_create"] . $file . "<br />");
...
print "\n\t<center><h2>".$gm_lang["excel_list"]."</h2>\n\t";
print "</center>";
