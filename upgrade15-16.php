...
if (file_exists("includes\db_layout.php") || file_exists("db_layout.php")) {
	print "Remove the file db_layout.php from your Genmod root directory<br />and from the includes directory first.<br />Afterwards, restart this script.<br /><br />";
