...
function print_user_favorites($block=true, $config="", $side, $index) {
		global $gm_lang, $GM_IMAGE_DIR, $GM_IMAGES, $GEDCOMS, $GEDCOM, $GEDCOMID, $TEXT_DIRECTION, $INDEX_DIRECTORY, $MEDIA_DIRECTORY,  $MEDIA_DIRECTORY_LEVELS, $command, $indilist, $sourcelist, $gm_username, $Privacy, $Users;
