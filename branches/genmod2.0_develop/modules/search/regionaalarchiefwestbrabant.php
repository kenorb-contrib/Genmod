...
class WestBrabantSearchModule {
	
	// Class information
	public $classname 		= "WestBrabantSearchModule";		// Name of the class
	public $display_name 	= "Regionaal Archief West-Brabant";	// Name to display on the dropdown menu
	...
	public $link			= "http://www.regionaalarchiefwestbrabant.nl/index.php?option=com_genealogie_zoeken&Itemid=144&sub=resultaat";
