...
$db_original[TBLPREFIX."actions"]["row"]["a_file"]["details"] = "TINYINT UNSIGNED";
...
$db_original[TBLPREFIX."actions"]["key"]["a_file"] = "KEY `a_gedfile` (`a_file`)";
...
$db_original[TBLPREFIX."changes"]["row"]["ch_file"]["details"] = "TINYINT UNSIGNED";
...
$db_original[TBLPREFIX."log"]["row"]["l_file"]["details"] = "TINYINT UNSIGNED DEFAULT NULL";
...
$db_original[TBLPREFIX."statscache"]["row"]["gs_file"]["details"] = "TINYINT UNSIGNED";
