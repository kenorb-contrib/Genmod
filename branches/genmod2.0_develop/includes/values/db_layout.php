...
$db_original[TBLPREFIX."actions"]["key"]["a_file"] = "KEY `a_file` (`a_file`)";
...
$db_original[TBLPREFIX."users"]["row"]["u_verified"]["details"] = "CHAR(1) CHARACTER SET #charset# COLLATE #collate#  DEFAULT NULL";
$db_original[TBLPREFIX."users"]["row"]["u_verified_by_admin"]["details"] = "CHAR(1) CHARACTER SET #charset# COLLATE #collate#  DEFAULT NULL";
...
$db_original[TBLPREFIX."users_gedcoms"]["row"]["ug_check_marriage_relations"]["details"] = "ENUM('N','Y','') NOT NULL DEFAULT ''";
