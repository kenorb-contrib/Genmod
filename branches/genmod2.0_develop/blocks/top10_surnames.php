 ...
 *
 * @version $Id: top10_surnames.php,v 1.11 2009/02/07 08:45:14 sjouke Exp $
 * @package Genmod
 * @subpackage Blocks
 */
...
function print_block_name_top10($block=true, $config="", $side, $index) {
	global $gm_lang, $GEDCOM, $DEBUG, $TEXT_DIRECTION;
	global $COMMON_NAMES_ADD, $COMMON_NAMES_REMOVE, $COMMON_NAMES_THRESHOLD, $GM_BLOCKS, $command, $GM_IMAGES, $GM_IMAGE_DIR, $gm_username, $Users;
