...
if ($custompage->action == "edit") {
	if ($custompage->task != GM_LANG_edit) {
		...
		print "<tr><td class=\"NavBlockLabel CustomPageTableOptionLabel\"><a href=\"custompage.php?action=".$custompage->action."&amp;task=".GM_LANG_edit."&amp;page_id=newpage\"><img src=\"".GM_IMAGE_DIR."/".$GM_IMAGES["edit"]["button"]."\" alt=\"".GM_LANG_edit."\" /></a>";
		print "&nbsp;</td>";
		print "<td class=\"NavBlockField\">".GM_LANG_new."</td></tr>";
		foreach ($custompage->pages as $ct => $page) {
			print "<tr><td class=\"NavBlockLabel CustomPageTableOptionLabel\"><a href=\"custompage.php?action=".$custompage->action."&amp;task=".GM_LANG_edit."&amp;page_id=".$page->id."\"><img src=\"".GM_IMAGE_DIR."/".$GM_IMAGES["edit"]["button"]."\" alt=\"".GM_LANG_edit."\" /></a>&nbsp;";
			print "<a href=\"custompage.php?action=".$custompage->action."&amp;task=".GM_LANG_delete."&amp;page_id=".$page->id."\" onclick=\"return confirm('".GM_LANG_confirm_page_delete."'); \"><img src=\"".GM_IMAGE_DIR."/".$GM_IMAGES["delete"]["button"]."\" alt=\"".GM_LANG_delete."\" /></a></td>";
