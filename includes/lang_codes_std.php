 ...
 * @version $Id: lang_codes_std.php,v 1.2 2008/01/06 11:16:37 roland-d Exp $
 *
 ...
 * The key field is the abbreviation, internal to Genmod, for the language.
 *
 * The abbreviations are used when a new language is to be implemented in Genmod.
 * For example, the abbreviation for "Croatian" is "hr".  This means that the various 
 * files within Genmod that are specific to Croatian would have .hr. as the last
 * part of the file name, and the Croatian flag would be croatia.gif.
 *
 * Note that Genmod allows the flag names to be other than as shown above.  For
