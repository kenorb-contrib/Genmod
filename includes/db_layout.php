 ...
 *
 * @version $Id: db_layout.php,v 1.72 2009/03/29 13:20:10 sjouke Exp $
 * @package Genmod
 * @subpackage DB
 */
...
if (isset($_POST["TBLPREFIX"])) $TBLPREFIX = $_POST["TBLPREFIX"];
...
$db_original[$TBLPREFIX."actions"]["row"]["a_gedfile"]["details"] = "TINYINT UNSIGNED";
...
$db_original[$TBLPREFIX."actions"]["key"]["a_gedfile"] = "KEY `a_gedfile` (`a_gedfile`)";
...
$db_original[$TBLPREFIX."changes"]["row"]["ch_gedfile"]["details"] = "INT(11) NOT NULL DEFAULT '0'";
...
$db_original[$TBLPREFIX."eventcache"]["row"]["ge_gedcom"]["details"] = "VARCHAR(64) CHARACTER SET #charset# COLLATE #collate#  NOT NULL ";
...
$db_original[$TBLPREFIX."eventcache"]["key"]["i_gedcom"] = "KEY `i_gedcom` (`ge_gedcom`)";
$db_original[$TBLPREFIX."eventcache"]["key"]["i_order"] = "KEY `i_order` (`ge_order`)";
$db_original[$TBLPREFIX."eventcache"]["key"]["i_cache"] = "KEY `i_cache` (`ge_cache`)";
...
$db_original[$TBLPREFIX."favorites"]["row"]["fv_file"]["details"] = "VARCHAR(64) CHARACTER SET #charset# COLLATE #collate# ";
...
$db_original[$TBLPREFIX."gedcoms"]["row"]["g_id"]["details"] = "TINYINT UNSIGNED NOT NULL DEFAULT '0'";
...
$db_original[$TBLPREFIX."gedconf"]["row"]["gc_multi_media"]["details"] = "TINYINT(1)";
...
$db_original[$TBLPREFIX."gedconf"]["row"]["gc_use_quick_update"]["details"] = "TINYINT(1)";
$db_original[$TBLPREFIX."gedconf"]["row"]["gc_show_quick_resn"]["details"] = "TINYINT(1)";
$db_original[$TBLPREFIX."gedconf"]["row"]["gc_quick_add_facts"]["details"] = "VARCHAR (255) CHARACTER SET #charset# COLLATE #collate# ";
$db_original[$TBLPREFIX."gedconf"]["row"]["gc_quick_required_facts"]["details"] = "VARCHAR (255) CHARACTER SET #charset# COLLATE #collate# ";
$db_original[$TBLPREFIX."gedconf"]["row"]["gc_quick_add_famfacts"]["details"] = "VARCHAR (255) CHARACTER SET #charset# COLLATE #collate# ";
$db_original[$TBLPREFIX."gedconf"]["row"]["gc_quick_required_famfacts"]["details"] = "VARCHAR (255) CHARACTER SET #charset# COLLATE #collate# ";
...
$db_original[$TBLPREFIX."gedconf"]["key"]["primary"] = "PRIMARY KEY  (`gc_gedcom`)";
...
$db_original[$TBLPREFIX."language"]["row"]["lg_english"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_hebrew"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_dutch"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_portuguese_br"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_czech"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_german"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_spanish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_french"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_italian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_hungarian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_norwegian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_polish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_finnish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_swedish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_turkish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_chinese"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_russian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_greek"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_arabic"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_lithuanian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_danish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_vietnamese"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language"]["row"]["lg_spanish_ar"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
...
$db_original[$TBLPREFIX."language_help"]["row"]["lg_english"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_hebrew"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_dutch"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_portuguese_br"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_last_update_date"]["details"] = "INT(11) NOT NULL DEFAULT '' DEFAULT '0'";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_last_update_by"]["details"] = "VARCHAR(100) CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT '' DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_czech"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_german"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_spanish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_french"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_italian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_hungarian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_norwegian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_polish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_finnish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_swedish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_turkish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_chinese"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_russian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_greek"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_arabic"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_lithuanian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_danish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_vietnamese"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."language_help"]["row"]["lg_spanish_ar"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
...
$db_original[$TBLPREFIX."lang_settings"]["row"]["ls_ALPHABET_upper"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."lang_settings"]["row"]["ls_ALPHABET_lower"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate#  NOT NULL DEFAULT ''";
...
$db_original[$TBLPREFIX."facts"]["row"]["lg_english"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_hebrew"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_dutch"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_portuguese_br"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_czech"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_german"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_spanish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_french"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_italian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_hungarian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_norwegian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_polish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_finnish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_swedish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_turkish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_chinese"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_russian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_greek"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_arabic"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_lithuanian"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_danish"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_vietnamese"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
$db_original[$TBLPREFIX."facts"]["row"]["lg_spanish_ar"]["details"] = "TEXT CHARACTER SET #charset# COLLATE #collate# NOT NULL DEFAULT ''";
...
$db_original[$TBLPREFIX."log"]["row"]["l_gedcom"]["details"] = "VARCHAR(64) CHARACTER SET #charset# COLLATE #collate# ";
...
$db_original[$TBLPREFIX."sources"]["key"]["primary"] = "PRIMARY KEY (`s_id`, `s_file`)";
...
$db_original[$TBLPREFIX."statscache"]["row"]["gs_gedcom"]["details"] = "VARCHAR(64) CHARACTER SET #charset# COLLATE #collate#  NOT NULL";
...
$db_original[$TBLPREFIX."statscache"]["key"]["primary"] = "PRIMARY KEY  (`gs_gedcom`)";
...
$db_original[$TBLPREFIX."users"]["row"]["u_verified"]["details"] = "VARCHAR(20) CHARACTER SET #charset# COLLATE #collate#  DEFAULT NULL";
$db_original[$TBLPREFIX."users"]["row"]["u_verified_by_admin"]["details"] = "VARCHAR(20) CHARACTER SET #charset# COLLATE #collate#  DEFAULT NULL";
$db_original[$TBLPREFIX."users"]["row"]["u_language"]["details"] = "VARCHAR(50) CHARACTER SET #charset# COLLATE #collate#  DEFAULT NULL";
$db_original[$TBLPREFIX."users"]["row"]["u_pwrequested"]["details"] = "VARCHAR(20) CHARACTER SET #charset# COLLATE #collate#  DEFAULT NULL";
