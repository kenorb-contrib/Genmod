 ...
 *
 * $Id: db_layer.php,v 1.27 2009/03/18 19:43:42 sjouke Exp $
 * @package Genmod
 * @subpackage Database
 */
...
class DbLayer extends MysqlDb {
	...
	function CheckDBLayout() {
		...
		if (file_exists("includes/db_layout.php")) require("includes/db_layout.php");
		else if (file_exists("db_layout.php")) require("db_layout.php");
		else return false;
