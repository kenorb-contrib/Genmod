...
/*=================================================
   charset=utf-8
   Project:	Genmod
   File:	facts.pl.php  [v.0.51 compatible with Genmod v. 2.53]
...
===================================================*/
# $Id: facts.pl.php,v 1.1 2005/10/23 21:54:42 roland-d Exp $
...
$factarray["_GMU"]	= "Ostatnie zmiany wprowadził(a)";
...
if (file_exists($GM_BASE_DIRECTORY . "languages/facts.pl.extra.php")) require $GM_BASE_DIRECTORY . "languages/facts.pl.extra.php";
