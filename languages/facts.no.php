<?php
/**
 * Norwegian GEDCOM Fact Codes File
 *
 * This file contains the Norwegian text for the GM GEDCOM Fact codes.
 *
 * Translation by Geir Håkon Eikland
 *
 * $Id: facts.no.php,v 1.1 2005/10/23 21:54:42 roland-d Exp $
 * @package Genmod
...
$factarray["_GMU"]	= "Sist oppdatert av";
...
if (file_exists($GM_BASE_DIRECTORY . "languages/facts.no.extra.php")) require $GM_BASE_DIRECTORY . "languages/facts.no.extra.php";
