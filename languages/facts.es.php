...
===================================================*/
# $Id: facts.es.php,v 1.1 2005/10/23 21:54:42 roland-d Exp $
...
if (file_exists($GM_BASE_DIRECTORY . "languages/facts.es.extra.php")) require $GM_BASE_DIRECTORY . "languages/facts.es.extra.php";
