...
if ($ancestry_controller->view == "preview") print "<h3>" . str_replace("#PEDIGREE_GENERATIONS#", ConvertNumber($PEDIGREE_GENERATIONS), $gm_lang["gen_ancestry_chart"]) . ":";
...
if ($ancestry_controller->view != "preview") {
	...
	<?php
	if (isset($ancestry_controller->max_generation) == true) print "<span class=\"error\">" . str_replace("#PEDIGREE_GENERATIONS#", ConvertNumber($ancestry_controller->num_generations), $gm_lang["max_generation"]) . "</span>";
	if (isset($ancestry_controller->min_generation) == true) print "<span class=\"error\">" . $gm_lang["min_generation"] . "</span>";
