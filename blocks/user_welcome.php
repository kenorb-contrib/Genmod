		...
		print "<div id=\"user_welcome\" class=\"BlockContainer\">\n";
			...
			print "<div class=\"BlockContent\">";
				if ($gm_user->editaccount) {
					print "<div class=\"UserBlockOwnLink\"><a href=\"edituser.php\"><img src=\"".GM_IMAGE_DIR."/".$GM_IMAGES["mygedview"]["small"]."\" border=\"0\" alt=\"".GM_LANG_myuserdata."\" title=\"".GM_LANG_myuserdata."\" /><br />".GM_LANG_myuserdata."</a></div>";
				}
