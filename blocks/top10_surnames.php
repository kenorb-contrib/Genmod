 ...
 *
 * @version $Id: top10_surnames.php,v 1.5 2006/02/19 18:40:23 roland-d Exp $
 * @package Genmod
 * @subpackage Blocks
 */
...
function print_block_name_top10($block=true, $config="", $side, $index) {
	...
	global $COMMON_NAMES_ADD, $COMMON_NAMES_REMOVE, $COMMON_NAMES_THRESHOLD, $GM_BLOCKS, $command, $GM_IMAGES, $GM_IMAGE_DIR, $gm_username;
