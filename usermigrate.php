...
if ($proceed == "backup") print_header($gm_lang["um_backup"]);
else print print_header($gm_lang["um_header"]);
...
if ($proceed == "backup") {
	...
	if ((!isset($_POST["um_config"])) && (!isset($_POST["um_gedcoms"])) && (!isset($_POST["um_gedsets"])) &&(!isset($_POST["um_logs"])) &&(!isset($_POST["um_usinfo"]))) {
		print "<div class=\"center\"><h2>".$gm_lang["um_backup"]."</h2></div>";
		print "<table align=\"center\" ><tr class=\"label\"><tr><td style=\"text-align:";
		if ($TEXT_DIRECTION == "ltr") print "left"; else print "right";
		print ";\" >".$gm_lang["um_bu_explain"]."<br /></td></tr>";
		?></table><br /><br />
		<form action="<?php print $SCRIPT_NAME; ?>" method="post">
		<table align="center">
			<tr class="label"><td style="padding: 5px" colspan="2" class="facts_label03"><?php print $gm_lang["options"]; ?></td></tr><br />
			<tr><td class="list_label" style="padding: 5px; text-align:<?php if ($TEXT_DIRECTION == "ltr") print "left"; else print "right";?>; "><?php print $gm_lang["um_bu_config"]; ?></td><td class="list_value" style="padding: 5px;"><input type="checkbox" name="um_config" value="yes" checked="checked" /></td></tr>
			<tr><td class="list_label" style="padding: 5px; text-align:<?php if ($TEXT_DIRECTION == "ltr") print "left"; else print "right";?>; "><?php print $gm_lang["um_bu_gedcoms"]; ?></td><td class="list_value" style="padding: 5px;"><input type="checkbox" name="um_gedcoms" value="yes" checked="checked" /></td></tr>
			<tr><td class="list_label" style="padding: 5px; text-align:<?php if ($TEXT_DIRECTION == "ltr") print "left"; else print "right";?>; "><?php print $gm_lang["um_bu_gedsets"]; ?></td><td class="list_value" style="padding: 5px;"><input type="checkbox" name="um_gedsets" value="yes" checked="checked" /></td></tr>
			<tr><td class="list_label" style="padding: 5px; text-align:<?php if ($TEXT_DIRECTION == "ltr") print "left"; else print "right";?>; "><?php print $gm_lang["um_bu_logs"]; ?></td><td class="list_value" style="padding: 5px;"><input type="checkbox" name="um_logs" value="yes" checked="checked" /></td></tr>
			<tr><td class="list_label" style="padding: 5px; text-align:<?php if ($TEXT_DIRECTION == "ltr") print "left"; else print "right";?>; "><?php print $gm_lang["um_bu_usinfo"]; ?></td><td class="list_value" style="padding: 5px;"><input type="checkbox" name="um_usinfo" value="yes" checked="checked" /></td></tr>
			<tr><td style="padding: 5px" colspan="2" class="facts_label03"><button type="submit" name="submit"><?php print $gm_lang["um_mk_bu"]; ?></button>
	...
	if (isset($_POST["um_logs"])) {
		foreach($GEDCOMS as $key => $gedcom) {
			...
			// Gedcom counters
			if (file_exists($INDEX_DIRECTORY.$gedcom["gedcom"]."gm_counters.php")) $flist[] = $INDEX_DIRECTORY.$gedcom["gedcom"]."gm_counters.php";
		...
		$dir_var = opendir ($INDEX_DIRECTORY);
		while ($file = readdir ($dir_var)) {
			if ((strpos($file, ".log") > 0) && (strstr($file, "gm-") !== false )) $flist[] = $INDEX_DIRECTORY.$file;
		}
		closedir($dir_var);
	}
	...
	// Make the zip
		...
		print "<tr class=\"label\"><td style=\"padding: 5px\" class=\"facts_label03\">".$gm_lang["um_results"]."</td></tr>";
	...
	if (count($flist) > 0) {
		...
		if ($v_list == 0) print "Error : ".$archive->errorInfo(true)."</td></tr>";
			...
			print "<tr><td class=\"list_value\" style=\"padding: 5px;\" ><a href=".$url."downloadbackup.php?fname=".$buname." target=_blank>".$gm_lang["um_zip_dl"]." ".$fname."</a>  (";
	...
	else print "<td style=\"padding: 5px\" class=\"list_label\">".$gm_lang["um_nofiles"]."</td></tr>";
	print "<tr class=\"label\"><td style=\"padding: 5px\" class=\"facts_label03\"><input type=\"button\" value=\"".$gm_lang["lang_back_admin"]."\" onclick=\"window.location='admin.php';\" /></td></tr></table><br /><br />";
...
if (($proceed == "export") || ($proceed == "exportovr")) {
	print "\n\t<h2>".$gm_lang["um_header"]."</h2>";
	print "<br /><br />";
	print $gm_lang["um_sql_index"];
	}
if ($proceed == "import") {
	print "\n\t<h2>".$gm_lang["um_header"]."</h2>";
	print "<br /><br />";
	print $gm_lang["um_index_sql"];
	print "<br /><br />";
}
...
if (($proceed != "import") && ($proceed != "export") && ($proceed != "exportovr")) {
	...
	<form action="usermigrate.php" method="post"><input type="hidden" name="proceed" value="import" />
		<table align="center" width="75%" ><tr class="label">
			<tr><td style="text-align:<?php if ($TEXT_DIRECTION == "ltr") print "left"; else print "right";?>; "><?php print $gm_lang["um_explain"].$gm_lang["um_proceed"]?><br />
			</td></tr>
			<tr><td><input type="submit" class="button" value="<?php print $gm_lang["um_import"];?>" />
			<input type="button" class="button" value="<?php print $gm_lang["um_export"];?>" onclick="window.location='usermigrate.php?proceed=export';"/>
			<input type="button" value="<?php print $gm_lang["lang_back_admin"];?>"  onclick="window.location='admin.php';"/><br /><br />
			</td></tr>
		</table>
		</form></div>
	<?php
...
function um_export() {
	global $INDEX_DIRECTORY, $TBLPREFIX, $DBCONN, $proceed, $gm_lang;
	

	// Get user array and create authenticate.php
	if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_creating"]." \"authenticate.php\"<br /><br />";
	$authtext = "<?php\n\n\$users = array();\n\n";
	$users = GetUsers();
	...
	if (file_exists($INDEX_DIRECTORY."authenticate.php")) {
		print $gm_lang["um_file_create_fail1"]." ".$INDEX_DIRECTORY."authenticate.php<br /><br />";
	}
	else {
		...
		if ($fp) {
			fwrite($fp, $authtext);
			fclose($fp);
			if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_file_create_succ1"]." authenticate.php<br /><br />";
		}
		else print $gm_lang["um_file_create_fail2"]." ".$INDEX_DIRECTORY."authenticate.php. ".$gm_lang["um_file_create_fail3"]."<br /><br />";
	}

	// Get messages and create messages.dat 
	if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_creating"]." \"messages.dat\"<br /><br />";
	$messages = array();
	$mesid = 1;
	...
	if ($mesid > 1) {
		$mstring = serialize($messages);
			...
			print $gm_lang["um_file_create_fail1"]." ".$INDEX_DIRECTORY."messages.dat<br /><br />";
		}
		else {
			...
			if ($fp) {
				fwrite($fp, $mstring);
				fclose($fp);
				if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_file_create_succ1"]." messages.dat<br /><br />";
			}
		else print $gm_lang["um_file_create_fail2"]." ".$INDEX_DIRECTORY."messages.dat. ".$gm_lang["um_file_create_fail3"]."<br /><br />";
		}
	}
	else {
		if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_nomsg"]." ".$gm_lang["um_file_not_created"]."<br /><br />";
	}
	...
	if ($favid > 1) {
		...
		if (file_exists($INDEX_DIRECTORY."favorites.dat")) {
			print $gm_lang["um_file_create_fail1"]." ".$INDEX_DIRECTORY."favorites.dat<br /><br />";
			}
		else {
			...
			if ($fp) {
				fwrite($fp, $mstring);
				fclose($fp);
				if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_file_create_succ1"]." favorites.dat<br /><br />";
			}
			else print $gm_lang["um_file_create_fail2"]." ".$INDEX_DIRECTORY."favorites.dat. ".$gm_lang["um_file_create_fail3"]."<br /><br />";
		}
	}
	else {
		if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_nofav"]." ".$gm_lang["um_file_not_created"]."<br /><br />";
	}
	...
	if (count($allnews) > 0) {
		...
		if (file_exists($INDEX_DIRECTORY."news.dat")) {
			print $gm_lang["um_file_create_fail1"].$INDEX_DIRECTORY."news.dat<br /><br />";
			}
		else {
			...
			if ($fp) {
				fwrite($fp, $mstring);
				fclose($fp);
				if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_file_create_succ1"]." news.dat<br /><br />";
			}
			else print $gm_lang["um_file_create_fail2"]." ".$INDEX_DIRECTORY."news.dat. ".$gm_lang["um_file_create_fail3"]."<br /><br />";
		}
	}
	else {
		if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_nonews"]." ".$gm_lang["um_file_not_created"]."<br /><br />";
	}

	// Get blocks and create blocks.dat 
	if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_creating"]." \"blocks.dat\"<br /><br />";
	$allblocks = array();
	$blocks["main"] = array();
	$blocks["right"] = array();
	...
	if (count($allblocks) > 0) {
		...
		if (file_exists($INDEX_DIRECTORY."blocks.dat")) {
			print $gm_lang["um_file_create_fail1"]." ".$INDEX_DIRECTORY."blocks.dat<br /><br />";
		}
		else {
			...
			if ($fp) {
				fwrite($fp, $mstring);
				fclose($fp);
				if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_file_create_succ1"]." blocks.dat<br /><br />";
			}
			else print $gm_lang["um_file_create_fail2"]." ".$INDEX_DIRECTORY."blocks.dat. ".$gm_lang["um_file_create_fail3"]."<br /><br />";
		}
	}
	else {
		if (($proceed == "export") || ($proceed == "exportovr")) print $gm_lang["um_noblocks"]." ".$gm_lang["um_file_not_created"]."<br /><br />";
	}
}
...
if (($proceed == "export") || ($proceed == "exportovr")) {
	...
	if ($proceed == "export") {
		...
		if ($i > 0) {
			print "<br />".$gm_lang["um_files_exist"]."<br /><br />";
			?>
			<form "<?php print $SCRIPT_NAME; ?>" method="post">
				<input type="hidden" class="button" value="<?php print $gm_lang["yes"];?>" />
				<input type="button" class="button" value="<?php print $gm_lang["yes"];?>" onclick="window.location='usermigrate.php?proceed=exportovr';"/>
				<input type="button" class="button" value="<?php print $gm_lang["no"];?>" onclick="window.location='admin.php';"/>
			</form>
			<?php
			print_footer();
			exit;
...
if ($proceed == "import") {
	...
	print "<br /><br />".$gm_lang["um_imp_users"]."<br />";
	if ((file_exists($INDEX_DIRECTORY."authenticate.php")) == false) {
		print $gm_lang["um_nousers"]."<br /><br />";
	print  "<a href=\"admin.php\">" . $gm_lang["lang_back_admin"] . "</a><br /><br />";
	exit;
	}
	...
	if ($countold == $countnew) {
		print $gm_lang["um_imp_succ"]."<br /><br />";
	}
	else {
		print $gm_lang["um_imp_fail"];
		exit;
	}
	...
	if ((file_exists($INDEX_DIRECTORY."blocks.dat")) == false) {
		print $gm_lang["um_noblocks"]."<br /><br />";
	}
	else {
		$allblocks = array();
