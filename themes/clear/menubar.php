 ...
 *
 * @package Genmod
 * @version $Id: menubar.php,v 1.3 2009/03/25 16:54:01 sjouke Exp $
 */
...
if (isset($note_controller) && $note_controller->classname == "NoteControllerRoot") $notemenu = $menubar->GetThisNoteMenu($note_controller);
else $notemenu = "";
if (isset($controller) && $controller->classname == "IndividualControllerRoot") $personmenu = $menubar->GetThisPersonMenu($controller);
else $personmenu = "";
if (isset($controller) && $controller->classname == "FamilyRoot") $familymenu = $menubar->GetThisFamilyMenu($controller);
else $familymenu = "";
if (isset($source_controller) && $source_controller->classname == "SourceControllerRoot") $sourcemenu = $menubar->GetThisSourceMenu($source_controller);
else $sourcemenu = "";
