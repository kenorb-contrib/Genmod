 ...
 * @package Genmod
 * @subpackage zwooff
 * @version $Id: gmrpc.php,v 1.20 2009/03/16 19:51:12 sjouke Exp $
 */
...
switch($action) {
	...
	case "getsourcedescriptor":
		...
		if (empty($sid)) print "";
			...
			if( DisplayDetailsByID($sid, "SOUR", 1, true)) print GetSourceDescriptor($sid)." (".$sid.")";
			else print "";
		}
	break;
	...
	case "getrepodescriptor":
		...
		if (empty($rid)) print "";
			...
			if( DisplayDetailsByID($rid, "REPO", 1, true)) print GetRepoDescriptor($rid)." (".$rid.")";
			else print "";
		}
	break;
	...
	case "getnotedescriptor":
		...
		if (empty($oid)) print "";
			...
			if ($note_controller->note->canDisplayDetails()) print $note_controller->note->GetTitle(40, true)." (".$oid.")";
			else print "";
		}
	break;
