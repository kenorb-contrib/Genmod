...
$db_original[TBLPREFIX."media_files"]["row"]["mf_bits"]["details"] = "INT(11) NOT NULL DEFAULT '0'";
$db_original[TBLPREFIX."media_files"]["row"]["mf_channels"]["details"] = "INT(11) NOT NULL DEFAULT '0'";
