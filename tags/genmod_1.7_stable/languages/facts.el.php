...
===================================================*/
# $Id: facts.el.php,v 1.9 2005/08/22 19:27:53 jfinlay Exp $
...
$factarray["_GMU"]		= "Τελευταία Αλλαγή απο";
...
if (file_exists($GM_BASE_DIRECTORY . "languages/facts.el.extra.php")) require $GM_BASE_DIRECTORY . "languages/facts.el.extra.php";
