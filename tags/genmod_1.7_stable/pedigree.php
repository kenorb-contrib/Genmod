...
print_header($name." ".$gm_lang["index_header"]);
print "<div id=\"content_pedigree\">";
if ($view=="preview") print "<h2>".str_replace("#PEDIGREE_GENERATIONS#", convert_number($PEDIGREE_GENERATIONS), $gm_lang["gen_ped_chart"]).":";
else print "<h2>".$gm_lang["index_header"].":";
